...
//        imgViewpProfile.contentMode = UIViewContentModeScaleAspectFit;
        ...
        lblBack = [[UILabel alloc ]initWithFrame:CGRectMake(0, self.contentView.frame.size.height - 30, self.contentView.frame.size.width, 30)];
        lblBack.backgroundColor = [UIColor clearColor];
        [self.contentView addSubview:lblBack];

        lblName = [[UILabel alloc ]initWithFrame:CGRectMake(0, 0, self.contentView.frame.size.width-40, 30)];
        ...
        lblNo = [[UILabel alloc ]initWithFrame:CGRectMake(self.contentView.frame.size.width-40, 0, 40, 30)];
        lblNo.font = [UIFont fontWithName:CGRegular size:textSize];
        ...
        lblTransView = [[UILabel alloc ]initWithFrame:CGRectMake(self.contentView.frame.size.width - 40, 0, 40, self.contentView.frame.size.height - 35)];
        ...
        lblCoreTmp = [[UILabel alloc ]initWithFrame:CGRectMake(self.contentView.frame.size.width - 40, 10, 44, 44)];
        lblCoreTmp.font = [UIFont fontWithName:CGRegular size:textSize];
        ...
        lblType1Tmp = [[UILabel alloc ]initWithFrame:CGRectMake(self.contentView.frame.size.width - 40, 50, 44, 44)];
        lblType1Tmp.font = [UIFont fontWithName:CGRegular size:textSize];
